...
void loop()
{
  ...
  dtostrf(ina.readBusVoltage(), 9, 5, f); 
  Serial.print(f);
  Serial.println(" V");

  Serial.print("Bus power:     ");
  dtostrf(ina.readBusPower(), 9, 5, f);
  Serial.print(f);
  Serial.println(" W");


  Serial.print("Shunt voltage: ");
  dtostrf(ina.readShuntVoltage(), 9, 5, f);
  Serial.print(f);
  Serial.println(" V");

  Serial.print("Shunt current: ");
  dtostrf(ina.readShuntCurrent(), 9, 5, f);
  Serial.print(f);
  Serial.println(" A");
